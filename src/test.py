...
class ModelTestMethods(unittest.TestCase):
    ...
    def test_AddTilesToSet(self):
        set = Set(self.root)
        t = Tile.create(1, GameConstants.BLACK, 1, set)
    ...
    def test_AddDoubleTileToGroup(self):
        ...
        self.assertEqual(set.addTile(Tile.create(1, GameConstants.BLACK, 1, set)), 1)
        self.assertEqual(set.addTile(Tile.create(2, GameConstants.BLUE, 1, set)), 2)
        self.assertEqual(set.addTile(Tile.create(3, GameConstants.RED, 1, set)), 3)

        # attempt to add another black 1 to the set, it should fail (addTile returns 0)
        self.assertEqual(set.addTile(Tile.create(4, GameConstants.BLACK, 1, set)), 0)
    ...
    def test_ValidRun(self):
        ...
        for v in range(1,4):
            t = Tile.create(v, GameConstants.BLACK, v, set)
    ...
    def test_AddTileToFullGroup(self):
        ...
        for c in GameConstants.TILECOLORS:
            ...
            i+=1
        # attempt to add another black 1 to the set, it should fail (addTile returns 0)
        self.assertEqual(set.addTile(Tile.create(5, GameConstants.BLACK, 1, set)), 0)

    def test_AddTileFitPosition(self):
        set = Set(self.root)
        self.assertEqual(set.addTile(Tile.create(5, GameConstants.BLACK, 4, set)), 1)
        #attempt to add a 3. it should be added to the front, restulting in fitpos==1
        self.assertEqual(set.addTile(Tile.create(6, GameConstants.BLACK, 3, set)), 1)
    ...
    def test_AddWrongTileToRun(self):
        ...
        for v in range(1,4):
            t = Tile.create(v, GameConstants.BLACK, v+3, set)
            self.assertEqual(set.addTile(t), v)
        # attempt to add another black 5 to the set, it should fail (addTile returns 0)
        self.assertEqual(set.addTile(Tile.create(5, GameConstants.BLACK, 4, set)), 0)
        # attempt to add a red 7 to the set, it should fail (addTile returns 0)
        self.assertEqual(set.addTile(Tile.create(6, GameConstants.RED, 7, set)), 0)
        # attempt to add a blue 1 to the set, it should fail (addTile returns 0)
        self.assertEqual(set.addTile(Tile.create(7, GameConstants.BLUE, 1, set)), 0)
    ...
    def test_AddJokerToFullGroup(self):
        ...
        self.assertEqual(set.addTile(Joker.create(5, GameConstants.BLACK, set)), 0)
    ...
    def test_AddJokerToRun(self):
        ...
        self.assertNotEqual(set.addTile(Joker.create(5, GameConstants.BLACK, set)), 0)
    ...
    def test_AddJokerToFullRun(self):
        ...
        for v in range(1,14):
            ...
            self.assertEqual(set.addTile(t), v)
        # attempt to add a joker to the set, it should fail (addTile returns a position == 0)
        self.assertEqual(set.addTile(Joker.create(15, GameConstants.BLACK, set)), 0)

    def test_AddRunToSetWithJoker(self):
        #create an empty set
        set = Set(self.root)
        #add a joker
        set.addTile(Joker.create(1, GameConstants.BLACK, set))
        # attempt to add a blue 7 to the set, it should NOT fail (addTile returns a pos>0)
        self.assertNotEqual(set.addTile(Tile.create(2, GameConstants.BLUE, 7, set)), 0)
        # attempt to add a blue 8 to the set, it should NOT fail (addTile returns a pos>0)
        self.assertNotEqual(set.addTile(Tile.create(3, GameConstants.BLUE, 8, set)), 0)
        # attempt to add a blue 5 to the set, it should NOT fail and addTile should return 1)
        self.assertEqual(set.addTile(Tile.create(4, GameConstants.BLUE, 5, set)), 1)
    ...
    def test_AddGroupToSetWithJoker(self):
        ...
        self.assertNotEqual(set.addTile(Tile.create(2, GameConstants.BLUE, 1, set)), 0)
        # attempt to add a red 1 to the set, it should NOT fail (addTile returns a pos>0)
        self.assertNotEqual(set.addTile(Tile.create(3, GameConstants.RED, 1, set)), 0)
